...
// fld=1~3->Gauge, com=1~3
#define GAUGE(com)      f[com][i][j][k]
#define GAUGED(com)     fd[com][i][j][k]
#define GAUGESUB1(com)  fsub1[com][i][j][k]
#define GAUGEDSUB1(com) fdsub1[com][i][j][k]
#define GAUGESUB2(com)  fsub2[com][i][j][k]
#define GAUGEDSUB2(com) fdsub2[com][i][j][k]
#define KGAUGE(com)     kf[com][i][j][k]
#define KGAUGED(com)    kfd[com][i][j][k]
// whole field
