...
#define BACKREACTION 0    // Backreaction Choice (0->Weak 1->Strong 2->BumpyAxionInflaiton)
#define POLARIZATION 1    // Polarization Vector Choice (0->Reciprocal 1->EffectiveMomentum)
#define MODEL 0           // Inflaton Potential Choice (0->Chaotic 1->BumpyAxion)
