...
void initialize_gf()
{
  ...
  if(seed>=0)
  {
    ...
    fftrn((double *)fd[1],(double *)fdnyquist_gf[0],NDIMS,arraysize,-1);
    fftrn((double *)f[2],(double *)fnyquist_gf[1],NDIMS,arraysize,-1);
    fftrn((double *)fd[2],(double *)fdnyquist_gf[1],NDIMS,arraysize,-1);
    fftrn((double *)f[3],(double *)fnyquist_gf[2],NDIMS,arraysize,-1);
    fftrn((double *)fd[3],(double *)fdnyquist_gf[2],NDIMS,arraysize,-1);
  }
