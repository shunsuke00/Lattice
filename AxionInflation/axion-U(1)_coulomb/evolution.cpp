      ...
      for(i=2;i<N-2;i++)
        for(j=2;j<N-2;j++)
          for(k=2;k<N-2;k++)
          {
            ...
            back_reaction  = ( pow(a,rescale_s)*GAUGED(1) ) * CROSSX;
            back_reaction += ( pow(a,rescale_s)*GAUGED(2) ) * CROSSY;
            back_reaction += ( pow(a,rescale_s)*GAUGED(3) ) * CROSSZ;
      ...
      for(i=0;i<N;i++) // Index in x direction
        for(j=0;j<N;j++) // Index in y direction
        {
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(a,rescale_s)*fd[1][i][j][edge_list[index]] ) * CROSSB_XZ;
            back_reaction += ( pow(a,rescale_s)*fd[2][i][j][edge_list[index]] ) * CROSSB_YZ;
            back_reaction += ( pow(a,rescale_s)*fd[3][i][j][edge_list[index]] ) * CROSSB_ZZ;
            temp -= d*g*backnorm*back_reaction;
          ...
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(a,rescale_s)*fd[1][i][edge_list[index]][j] ) * CROSSB_XY;
            back_reaction += ( pow(a,rescale_s)*fd[2][i][edge_list[index]][j] ) * CROSSB_YY;
            back_reaction += ( pow(a,rescale_s)*fd[3][i][edge_list[index]][j] ) * CROSSB_ZY;
            temp -= d*g*backnorm*back_reaction;
          ...
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(a,rescale_s)*fd[1][edge_list[index]][i][j] ) * CROSSB_XX;
            back_reaction += ( pow(a,rescale_s)*fd[2][edge_list[index]][i][j] ) * CROSSB_YX;
            back_reaction += ( pow(a,rescale_s)*fd[3][edge_list[index]][i][j] ) * CROSSB_ZX;
            temp -= d*g*backnorm*back_reaction;
      ...
      for(i=2;i<N-2;i++)
        for(j=2;j<N-2;j++)
          for(k=2;k<N-2;k++)
          {
            ...
            back_reaction  = ( pow(asub1,rescale_s)*GAUGEDSUB1(1) ) * CROSSX;
            back_reaction += ( pow(asub1,rescale_s)*GAUGEDSUB1(2) ) * CROSSY;
            back_reaction += ( pow(asub1,rescale_s)*GAUGEDSUB1(3) ) * CROSSZ;
            temp -= d*g*backnorm*back_reaction;
            KAXIOND += temp/3.;
      ...
      for(i=0;i<N;i++) // Index in x direction
        for(j=0;j<N;j++) // Index in y direction
        {
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(asub1,rescale_s)*fdsub1[1][i][j][edge_list[index]] ) * CROSSB_XZ;
            back_reaction += ( pow(asub1,rescale_s)*fdsub1[2][i][j][edge_list[index]] ) * CROSSB_YZ;
            back_reaction += ( pow(asub1,rescale_s)*fdsub1[3][i][j][edge_list[index]] ) * CROSSB_ZZ;
            temp -= d*g*backnorm*back_reaction;
          ...
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(asub1,rescale_s)*fdsub1[1][i][edge_list[index]][j] ) * CROSSB_XY;
            back_reaction += ( pow(asub1,rescale_s)*fdsub1[2][i][edge_list[index]][j] ) * CROSSB_YY;
            back_reaction += ( pow(asub1,rescale_s)*fdsub1[3][i][edge_list[index]][j] ) * CROSSB_ZY;
            temp -= d*g*backnorm*back_reaction;
          ...
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(asub1,rescale_s)*fdsub1[1][edge_list[index]][i][j] ) * CROSSB_XX;
            back_reaction += ( pow(asub1,rescale_s)*fdsub1[2][edge_list[index]][i][j] ) * CROSSB_YX;
            back_reaction += ( pow(asub1,rescale_s)*fdsub1[3][edge_list[index]][i][j] ) * CROSSB_ZX;
            temp -= d*g*backnorm*back_reaction;
      ...
      for(i=2;i<N-2;i++)
        for(j=2;j<N-2;j++)
          for(k=2;k<N-2;k++)
          {
            ...
            back_reaction  = ( pow(asub2,rescale_s)*GAUGEDSUB2(1) ) * CROSSX;
            back_reaction += ( pow(asub2,rescale_s)*GAUGEDSUB2(2) ) * CROSSY;
            back_reaction += ( pow(asub2,rescale_s)*GAUGEDSUB2(3) ) * CROSSZ;
            temp -= d*g*backnorm*back_reaction;
            KAXIOND += temp/3.;
      ...
      for(i=0;i<N;i++) // Index in x direction
        for(j=0;j<N;j++) // Index in y direction
        {
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(asub2,rescale_s)*fdsub2[1][i][j][edge_list[index]] ) * CROSSB_XZ;
            back_reaction += ( pow(asub2,rescale_s)*fdsub2[2][i][j][edge_list[index]] ) * CROSSB_YZ;
            back_reaction += ( pow(asub2,rescale_s)*fdsub2[3][i][j][edge_list[index]] ) * CROSSB_ZZ;
            temp -= d*g*backnorm*back_reaction;
            kfd[0][i][j][edge_list[index]] += temp/3.;
          ...
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(asub2,rescale_s)*fdsub2[1][i][edge_list[index]][j] ) * CROSSB_XY;
            back_reaction += ( pow(asub2,rescale_s)*fdsub2[2][i][edge_list[index]][j] ) * CROSSB_YY;
            back_reaction += ( pow(asub2,rescale_s)*fdsub2[3][i][edge_list[index]][j] ) * CROSSB_ZY;
            temp -= d*g*backnorm*back_reaction;
            kfd[0][i][edge_list[index]][j] += temp/3.;
          ...
          for(index=0;index<4;index++)
          {
            ...
            back_reaction  = ( pow(asub2,rescale_s)*fdsub2[1][edge_list[index]][i][j] ) * CROSSB_XX;
            back_reaction += ( pow(asub2,rescale_s)*fdsub2[2][edge_list[index]][i][j] ) * CROSSB_YX;
            back_reaction += ( pow(asub2,rescale_s)*fdsub2[3][edge_list[index]][i][j] ) * CROSSB_ZX;
            temp -= d*g*backnorm*back_reaction;
            kfd[0][edge_list[index]][i][j] += temp/3.;
            ...
            for(k=2;k<N-2;k++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIV_AX(y)*(asnorm2*GAUGED(3)) - DERIV_AX(z)*(asnorm2*GAUGED(2)) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*AXIOND*CROSSY;
                  interaction -= laplnorm*( DERIV_AX(z)*(asnorm2*GAUGED(1)) - DERIV_AX(x)*(asnorm2*GAUGED(3)) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*AXIOND*CROSSZ;
                  interaction -= laplnorm*( DERIV_AX(x)*(asnorm2*GAUGED(2)) - DERIV_AX(y)*(asnorm2*GAUGED(1)) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_Z(y)*(asnorm2*fd[3][i][j][edge_list[index]]) - DERIVB_AX_Z(z)*(asnorm2*fd[2][i][j][edge_list[index]]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fd[0][i][j][edge_list[index]]*CROSSB_YZ;
                  interaction -= laplnorm*( DERIVB_AX_Z(z)*(asnorm2*fd[1][i][j][edge_list[index]]) - DERIVB_AX_Z(x)*(asnorm2*fd[3][i][j][edge_list[index]]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fd[0][i][j][edge_list[index]]*CROSSB_ZZ;
                  interaction -= laplnorm*( DERIVB_AX_Z(x)*(asnorm2*fd[2][i][j][edge_list[index]]) - DERIVB_AX_Z(y)*(asnorm2*fd[1][i][j][edge_list[index]]) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_Y(y)*(asnorm2*fd[3][i][edge_list[index]][j]) - DERIVB_AX_Y(z)*(asnorm2*fd[2][i][edge_list[index]][j]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fd[0][i][edge_list[index]][j]*CROSSB_YY;
                  interaction -= laplnorm*( DERIVB_AX_Y(z)*(asnorm2*fd[1][i][edge_list[index]][j]) - DERIVB_AX_Y(x)*(asnorm2*fd[3][i][edge_list[index]][j]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fd[0][i][edge_list[index]][j]*CROSSB_ZY;
                  interaction -= laplnorm*( DERIVB_AX_Y(x)*(asnorm2*fd[2][i][edge_list[index]][j]) - DERIVB_AX_Y(y)*(asnorm2*fd[1][i][edge_list[index]][j]) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_X(y)*(asnorm2*fd[3][edge_list[index]][i][j]) - DERIVB_AX_X(z)*(asnorm2*fd[2][edge_list[index]][i][j]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fd[0][edge_list[index]][i][j]*CROSSB_YX;
                  interaction -= laplnorm*( DERIVB_AX_X(z)*(asnorm2*fd[1][edge_list[index]][i][j]) - DERIVB_AX_X(x)*(asnorm2*fd[3][edge_list[index]][i][j]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fd[0][edge_list[index]][i][j]*CROSSB_ZX;
                  interaction -= laplnorm*( DERIVB_AX_X(x)*(asnorm2*fd[2][edge_list[index]][i][j]) - DERIVB_AX_X(y)*(asnorm2*fd[1][edge_list[index]][i][j]) );
                  break;
                }
                default:
                {
            ...
            for(k=2;k<N-2;k++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIV_AX(y)*(asnorm2*GAUGEDSUB1(3)) - DERIV_AX(z)*(asnorm2*GAUGEDSUB1(2)) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*AXIONDSUB1*CROSSY;
                  interaction -= laplnorm*( DERIV_AX(z)*(asnorm2*GAUGEDSUB1(1)) - DERIV_AX(x)*(asnorm2*GAUGEDSUB1(3)) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*AXIONDSUB1*CROSSZ;
                  interaction -= laplnorm*( DERIV_AX(x)*(asnorm2*GAUGEDSUB1(2)) - DERIV_AX(y)*(asnorm2*GAUGEDSUB1(1)) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_Z(y)*(asnorm2*fdsub1[3][i][j][edge_list[index]]) - DERIVB_AX_Z(z)*(asnorm2*fdsub1[2][i][j][edge_list[index]]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fdsub1[0][i][j][edge_list[index]]*CROSSB_YZ;
                  interaction -= laplnorm*( DERIVB_AX_Z(z)*(asnorm2*fdsub1[1][i][j][edge_list[index]]) - DERIVB_AX_Z(x)*(asnorm2*fdsub1[3][i][j][edge_list[index]]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fdsub1[0][i][j][edge_list[index]]*CROSSB_ZZ;
                  interaction -= laplnorm*( DERIVB_AX_Z(x)*(asnorm2*fdsub1[2][i][j][edge_list[index]]) - DERIVB_AX_Z(y)*(asnorm2*fdsub1[1][i][j][edge_list[index]]) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_Y(y)*(asnorm2*fdsub1[3][i][edge_list[index]][j]) - DERIVB_AX_Y(z)*(asnorm2*fdsub1[2][i][edge_list[index]][j]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fdsub1[0][i][edge_list[index]][j]*CROSSB_YY;
                  interaction -= laplnorm*( DERIVB_AX_Y(z)*(asnorm2*fdsub1[1][i][edge_list[index]][j]) - DERIVB_AX_Y(x)*(asnorm2*fdsub1[3][i][edge_list[index]][j]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fdsub1[0][i][edge_list[index]][j]*CROSSB_ZY;
                  interaction -= laplnorm*( DERIVB_AX_Y(x)*(asnorm2*fdsub1[2][i][edge_list[index]][j]) - DERIVB_AX_Y(y)*(asnorm2*fdsub1[1][i][edge_list[index]][j]) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_X(y)*(asnorm2*fdsub1[3][edge_list[index]][i][j]) - DERIVB_AX_X(z)*(asnorm2*fdsub1[2][edge_list[index]][i][j]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fdsub1[0][edge_list[index]][i][j]*CROSSB_YX;
                  interaction -= laplnorm*( DERIVB_AX_X(z)*(asnorm2*fdsub1[1][edge_list[index]][i][j]) - DERIVB_AX_X(x)*(asnorm2*fdsub1[3][edge_list[index]][i][j]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fdsub1[0][edge_list[index]][i][j]*CROSSB_ZX;
                  interaction -= laplnorm*( DERIVB_AX_X(x)*(asnorm2*fdsub1[2][edge_list[index]][i][j]) - DERIVB_AX_X(y)*(asnorm2*fdsub1[1][edge_list[index]][i][j]) );
                  break;
                }
                default:
                {
            ...
            for(k=2;k<N-2;k++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIV_AX(y)*(asnorm2*GAUGEDSUB2(3)) - DERIV_AX(z)*(asnorm2*GAUGEDSUB2(2)) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*AXIONDSUB2*CROSSY;
                  interaction -= laplnorm*( DERIV_AX(z)*(asnorm2*GAUGEDSUB2(1)) - DERIV_AX(x)*(asnorm2*GAUGEDSUB2(3)) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*AXIONDSUB2*CROSSZ;
                  interaction -= laplnorm*( DERIV_AX(x)*(asnorm2*GAUGEDSUB2(2)) - DERIV_AX(y)*(asnorm2*GAUGEDSUB2(1)) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_Z(y)*(asnorm2*fdsub2[3][i][j][edge_list[index]]) - DERIVB_AX_Z(z)*(asnorm2*fdsub2[2][i][j][edge_list[index]]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fdsub2[0][i][j][edge_list[index]]*CROSSB_YZ;
                  interaction -= laplnorm*( DERIVB_AX_Z(z)*(asnorm2*fdsub2[1][i][j][edge_list[index]]) - DERIVB_AX_Z(x)*(asnorm2*fdsub2[3][i][j][edge_list[index]]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fdsub2[0][i][j][edge_list[index]]*CROSSB_ZZ;
                  interaction -= laplnorm*( DERIVB_AX_Z(x)*(asnorm2*fdsub2[2][i][j][edge_list[index]]) - DERIVB_AX_Z(y)*(asnorm2*fdsub2[1][i][j][edge_list[index]]) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_Y(y)*(asnorm2*fdsub2[3][i][edge_list[index]][j]) - DERIVB_AX_Y(z)*(asnorm2*fdsub2[2][i][edge_list[index]][j]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fdsub2[0][i][edge_list[index]][j]*CROSSB_YY;
                  interaction -= laplnorm*( DERIVB_AX_Y(z)*(asnorm2*fdsub2[1][i][edge_list[index]][j]) - DERIVB_AX_Y(x)*(asnorm2*fdsub2[3][i][edge_list[index]][j]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fdsub2[0][i][edge_list[index]][j]*CROSSB_ZY;
                  interaction -= laplnorm*( DERIVB_AX_Y(x)*(asnorm2*fdsub2[2][i][edge_list[index]][j]) - DERIVB_AX_Y(y)*(asnorm2*fdsub2[1][i][edge_list[index]][j]) );
                  break;
                }
                default:
                {
            ...
            for(index=0;index<4;index++)
            {
              ...
              switch(fldg)
              {
                case 1:
                {
                  ...
                  interaction -= laplnorm*( DERIVB_AX_X(y)*(asnorm2*fdsub2[3][edge_list[index]][i][j]) - DERIVB_AX_X(z)*(asnorm2*fdsub2[2][edge_list[index]][i][j]) );
                  break;
                }
                case 2:
                {
                  interaction  = asnorm*fdsub2[0][edge_list[index]][i][j]*CROSSB_YX;
                  interaction -= laplnorm*( DERIVB_AX_X(z)*(asnorm2*fdsub2[1][edge_list[index]][i][j]) - DERIVB_AX_X(x)*(asnorm2*fdsub2[3][edge_list[index]][i][j]) );
                  break;
                }
                case 3:
                {
                  interaction  = asnorm*fdsub2[0][edge_list[index]][i][j]*CROSSB_ZX;
                  interaction -= laplnorm*( DERIVB_AX_X(x)*(asnorm2*fdsub2[2][edge_list[index]][i][j]) - DERIVB_AX_X(y)*(asnorm2*fdsub2[1][edge_list[index]][i][j]) );
                  break;
                }
                default:
                {
