...
#define DERIV_GF(dir,com) deriv_##dir(com+1,i,j,k,kloop_arg,FSUB)
// Gauge derivative on boundary, dir=x,y,z, com=0~3
#define DERIVB_GF_Z(dir,com) deriv_##dir##b(com+1,i,j,edge_list[index],kloop_arg,FSUB)
#define DERIVB_GF_Y(dir,com) deriv_##dir##b(com+1,i,edge_list[index],j,kloop_arg,FSUB) 
#define DERIVB_GF_X(dir,com) deriv_##dir##b(com+1,edge_list[index],i,j,kloop_arg,FSUB)

// Rotation of gauge field
#define CROSSX (deriv_y(4,i,j,k,kloop_arg,FSUB) - deriv_z(3,i,j,k,kloop_arg,FSUB))
#define CROSSY (deriv_z(2,i,j,k,kloop_arg,FSUB) - deriv_x(4,i,j,k,kloop_arg,FSUB))
#define CROSSZ (deriv_x(3,i,j,k,kloop_arg,FSUB) - deriv_y(2,i,j,k,kloop_arg,FSUB))
// Rotation of gauge field on boundary, CROSSB_<direction><edge coordinate>
#define CROSSB_XZ ( deriv_yb(4,i,j,edge_list[index],kloop_arg,FSUB) - deriv_zb(3,i,j,edge_list[index],kloop_arg,FSUB) )
#define CROSSB_YZ ( deriv_zb(2,i,j,edge_list[index],kloop_arg,FSUB) - deriv_xb(4,i,j,edge_list[index],kloop_arg,FSUB) )
#define CROSSB_ZZ ( deriv_xb(3,i,j,edge_list[index],kloop_arg,FSUB) - deriv_yb(2,i,j,edge_list[index],kloop_arg,FSUB) )
#define CROSSB_XY ( deriv_yb(4,i,edge_list[index],j,kloop_arg,FSUB) - deriv_zb(3,i,edge_list[index],j,kloop_arg,FSUB) )
#define CROSSB_YY ( deriv_zb(2,i,edge_list[index],j,kloop_arg,FSUB) - deriv_xb(4,i,edge_list[index],j,kloop_arg,FSUB) )
#define CROSSB_ZY ( deriv_xb(3,i,edge_list[index],j,kloop_arg,FSUB) - deriv_yb(2,i,edge_list[index],j,kloop_arg,FSUB) )
#define CROSSB_XX ( deriv_yb(4,edge_list[index],i,j,kloop_arg,FSUB) - deriv_zb(3,edge_list[index],i,j,kloop_arg,FSUB) )
#define CROSSB_YX ( deriv_zb(2,edge_list[index],i,j,kloop_arg,FSUB) - deriv_xb(4,edge_list[index],i,j,kloop_arg,FSUB) )
#define CROSSB_ZX ( deriv_xb(3,edge_list[index],i,j,kloop_arg,FSUB) - deriv_yb(2,edge_list[index],i,j,kloop_arg,FSUB) )
